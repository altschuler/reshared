        ...
        <div>
            <Form layout="vertical">
                ...
                <Form.Item
                    ...
                    <DatePicker
                        value={present.expiry ? dayjs(present.expiry) : null}
                        onChange={(expiry) => state.update({ expiry: expiry?.toDate() })}
                    />
                </Form.Item>
...
export const asThingUpdateInput = ({ present }: ThingEditorState): UpdateThingInput => ({
    ...
    description: present.description,
    type: present.type,
    expiry: present.expiry ? dayjs(present.expiry).toISOString() : undefined,
    enabled: present.enabled,
